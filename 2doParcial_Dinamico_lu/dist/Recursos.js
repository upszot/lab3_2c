var Recursos = /** @class */ (function () {
    ...
    Recursos.prototype.getOS = function () {
        var OSName = "Unknown";
     ...
     *
     */
    Recursos.prototype.ponerSpinner = function () {
     ...
     * @param {*} value
     */
    Recursos.prototype.agregarComboBox = function (listadoArray, clave, value) {
    ...
    Recursos.prototype.agregarComboBoxSimple = function (listadoArray, valor, id) {
        var select = document.createElement("select");
     ...
     * @param {*} clas
     */
    Recursos.prototype.agregarBoton = function (texto, clas) {
     ...
     *
     */
    Recursos.prototype.agregarSalto = function () {
     ...
     * @param {*} key
     */
    Recursos.prototype.agregarLabel = function (key, id) {
     ...
     * @param {*} name
     */
    Recursos.prototype.agregarRadioButtons = function (valor, activo, nombre, name) {
     ...
     * @param {*} activo
     */
    Recursos.prototype.agregarCheckBox = function (valor, activo) {
        var input = document.createElement('input');
    ...
    Recursos.prototype.agregarTextInput = function (key, valor) {
        var input = document.createElement('input');
    ...
    Recursos.prototype.agregarTextPass = function (key) {
        var input = document.createElement('input');
    ...
    Recursos.prototype.cambiarColorBack = function () {
        var inputColor = document.getElementById('elegirColor');
        inputColor.addEventListener('change', function () {
            var valor = document.getElementById('elegirColor').value;
